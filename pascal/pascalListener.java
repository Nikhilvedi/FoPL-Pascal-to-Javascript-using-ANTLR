...
public interface pascalListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link pascalParser#directive}.
	 * @param ctx the parse tree
	 */
	void enterDirective(pascalParser.DirectiveContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#directive}.
	 * @param ctx the parse tree
	 */
	void exitDirective(pascalParser.DirectiveContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link pascalParser#exitStatement}.
	 * @param ctx the parse tree
	 */
	void enterExitStatement(pascalParser.ExitStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#exitStatement}.
	 * @param ctx the parse tree
	 */
	void exitExitStatement(pascalParser.ExitStatementContext ctx);
	/**
